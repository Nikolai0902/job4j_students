...
import ru.serv_r.filter.JWTAuthenticationFilter;
import ru.serv_r.filter.JWTAuthorizationFilter;
import ru.serv_r.sevice.PersonService;

import static ru.serv_r.filter.JWTAuthenticationFilter.SIGN_UP_URL;
